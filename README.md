...
| Desktop (real app) | Mobile (real app) |
| --- | --- |
| ![TradeBuddy Desktop Screenshot](images/screenshot-web-desktop.png) | ![TradeBuddy Mobile Screenshot](images/screenshot-web-mobile.png) |
