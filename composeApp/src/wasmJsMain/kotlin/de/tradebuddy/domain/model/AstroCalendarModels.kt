...
enum class AstroPlanet(
    ...
    Moon(label = "Mond", glyph = "\u263D\uFE0E"),
    Sun(label = "Sonne", glyph = "\u2609\uFE0E"),
    Mercury(label = "Merkur", glyph = "\u263F\uFE0E"),
    Venus(label = "Venus", glyph = "\u2640\uFE0E"),
    Mars(label = "Mars", glyph = "\u2642\uFE0E"),
    Jupiter(label = "Jupiter", glyph = "\u2643\uFE0E"),
    Saturn(label = "Saturn", glyph = "\u2644\uFE0E"),
    Uranus(label = "Uranus", glyph = "\u2645\uFE0E"),
    Neptune(label = "Neptun", glyph = "\u2646\uFE0E"),
    Pluto(label = "Pluto", glyph = "\u2647\uFE0E")
}
