...
import trade_buddy.composeapp.generated.resources.moon_phase_header
...
import trade_buddy.composeapp.generated.resources.moon_phase_title
        ...
        Column(
            ...
            Row(
                ...
                Column(Modifier.weight(1f)) {
                    Text(stringResource(Res.string.moon_phase_title), style = MaterialTheme.typography.titleMedium)
                    Text(
                        stringResource(Res.string.moon_phase_header, monthLabel, userZone.id),
            ...
            if (!state.isLoading && state.error == null) {
                if (state.phases.isEmpty()) {
                    ...
                    LazyColumn(
                        ...
                        items(state.phases, key = { it.instant }) { phase ->
